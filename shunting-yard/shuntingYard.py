# -*- coding: utf-8 -*-
"""Shunting Yard Algorithm Application Problem

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/17jU7NZB6kfPiELbnsFOJWnLb5BqzrxhJ

This can take simple infix math equations (as strings) and convert them to reverse polish notation based on the shunting yard algorithm (designed by Dijkstra, of course). It uses 2 stacks to pull apart and reassemble the equation in the correct order.
"""

# This is a very simple stack data struct for holding equations
...
# These parts are needed for moving operators from the operator stack
#   into the output stack in the correct order.

# This is of course order of operations, which we use to ensure that all
...
# This is really just for exponents, since exponents are right
# associated (meaning the exponent section is grouped)
...
# This is the actual shunting yard algorithm function
# It assumes the passed string has a space between all characters,
# and that parenthesis are correct. It also treats any characters as
# variables
